<template>
  <div
    ...
    v-bind:class="{
      ...
      'theme-january': theme === 'january',
      'theme-february': theme === 'february',
      'theme-march': theme === 'march',
      'theme-april': theme === 'april',
      'theme-may': theme === 'may',
      'theme-june': theme === 'june',
      'theme-july': theme === 'july',
      'theme-august': theme === 'august',
      'theme-september': theme === 'september',
      'theme-october': theme === 'october',
      'theme-november': theme === 'november',
      'theme-december': theme === 'december',
      hideoutline,
    }"
