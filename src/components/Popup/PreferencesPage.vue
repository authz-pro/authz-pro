  ...
  <div>
    ...
    >
      ...
      <optgroup label="Monthly">
        <option value="january">{{ i18n.theme_january }}</option>
        <option value="february">{{ i18n.theme_february }}</option>
        <option value="march">{{ i18n.theme_march }}</option>
        <option value="april">{{ i18n.theme_april }}</option>
        <option value="may">{{ i18n.theme_may }}</option>
        <option value="june">{{ i18n.theme_june }}</option>
        <option value="july">{{ i18n.theme_july }}</option>
        <option value="august">{{ i18n.theme_august }}</option>
        <option value="september">{{ i18n.theme_september }}</option>
        <option value="october">{{ i18n.theme_october }}</option>
        <option value="november">{{ i18n.theme_november }}</option>
        <option value="december">{{ i18n.theme_december }}</option>
      </optgroup>
    </a-select-input>
    <a-select-input
      :label="i18n.scale"
