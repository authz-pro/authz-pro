...
> AuthZ Pro generates two-factor authentication codes in your browser. Simple. Secure. Everywhere.
...
To reproduce a build for Safari, please follow the upstream contribution guidance.
